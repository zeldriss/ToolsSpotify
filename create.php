...
curl_setopt($ch, CURLOPT_POSTFIELDS, "iagree=true&birth_day=12&platform=Android-ARM&creation_point=client_mobile&password=$pass&key=142b583129b2df829de3656f9eb484e6&birth_year=2000&email=$email&gender=male&app_version=849800892&birth_month=12&password_repeat=$pass");
...
if ($json->status == "20") {
	...
	if ($json->status == 1) {
		...
		echo " $email => success \n";
		fwrite(fopen("createe.txt", "a"), "$email|$pass\n");
	}
}
}
